  ...
  return (
    ...
    >
      ...
      <p style={{ marginBottom: 'var(--space-4)' }}>
        By using this service, you agree to these terms. The service is provided
      ...
      <p style={{ marginBottom: 'var(--space-4)' }}>
        ...
        including CV content and job preferences. You may delete your account at
        any time via Settings → Delete account.
      </p>
      <p>
